...
This document defines requirements for `helix-daemon` using EARS notation.
...
| ID       | Acceptance Criterion                                              |
| -------- | ----------------------------------------------------------------- |
| AC-002.1 | THE SYSTEM SHALL listen on Unix socket `~/.helix/run/helixd.sock` |
