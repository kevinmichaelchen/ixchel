    ...
    <div class="p-1">
      ...
      >
        <span class="flex items-center gap-2">
          <svg
            class="h-4 w-4 text-foreground-alt"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <svg
          class="h-4 w-4 text-foreground-alt transition-transform"
          class:rotate-90={expandedSection === 'status'}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      >
        ...
        <svg
          class="h-4 w-4 text-foreground-alt transition-transform"
          class:rotate-90={expandedSection === 'priority'}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
