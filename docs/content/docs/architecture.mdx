...
│                         CLI Tools Layer                              │
│                                                                      │
│   hbd        adr-search    helix-docs    helix-map    helix-repo   │
│   (issues)   (decisions)   (research)    (codebase)   (clones)     │
│                                                                      │
└──────────────────────────────┬──────────────────────────────────────┘
                               │
┌──────────────────────────────┴──────────────────────────────────────┐
│                        Shared Libraries                              │
│                                                                      │
│   helix-id             helix-config          helix-embed (planned)  │
│   (hash IDs)           (settings)            (fastembed)            │
│                                                                      │
└──────────────────────────────┬──────────────────────────────────────┘
                               │
┌──────────────────────────────┴──────────────────────────────────────┐
...
```
helix-tools/
├── adr-search/             # ADR semantic search CLI
├── hbd/                    # Issue tracker CLI
├── helix-docs/             # Documentation cache CLI
├── helix-map/              # Codebase indexer CLI
├── helix-repo/             # Repository clone manager
│
├── shared/
│   ├── helix-id/           # Hash-based ID generation
│   └── helix-config/       # Configuration loading
│
